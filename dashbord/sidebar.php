  <div class="col-2 sidebar d-flex align-items-center flex-column vh-100">
                <h1 class=" mt-3 text-start border-start border-5 border-primary ps-1 align-self-start mb-5 fs-2  " id="changeTailleOfH1">E-Classe</h1>
                ...
                <nav class="w-75 mx-auto" title="mainPrincipale">
                    <ul class="w-100 mt-5 menu-items list-unstyled">
                        <li>
                            <a href="dashboard.php" class="btn btn-primary w-100 "> <span class="ic ic-home"></span> <span>Home</span> </a>
                        </li>
                        <li>
                            <a href="#" class="btn  w-100"> <span class="ic ic-course"></span><span>Courses</span></a>
                        </li>
                        <li>
                            <a href="students.php" class="btn    w-100"> <span class=" ic ic-student "></span><span>Student</span></a>
                        </li>
                        <li>
                            <a href="payments.php" class="btn    w-100"> <span class=" ic ic-payment "></span><span>Payment</span></a>
                        </li>
                        <li>
